...
const Spinner = () => {
    return (
        ...
        //     <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white opacity-20">Aguarde um instante</h5>
        //     <p class="font-normal text-gray-700 dark:text-gray-400 opacity-20">Ainda não coma sua pipoca, estamos encontrando seu filme...</p>
